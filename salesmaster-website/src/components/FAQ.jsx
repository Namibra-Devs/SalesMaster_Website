  ...
  const faqs = [
    {
      ...
      answer:
        "Most businesses can get SalesMaster up and running in under 30 minutes. Our intuitive setup wizard guides you through the process step by step, and you can start processing sales immediately after installation.",
    },
    {
      question: "Does SalesMaster work offline?",
      answer:
        "Yes! SalesMaster includes offline mode functionality. You can continue processing sales, managing inventory, and generating reports even without an internet connection. All data syncs automatically when connectivity is restored.",
    },
    {
      question: "Can I manage multiple store locations with one account?",
      answer:
        "Absolutely. SalesMaster's multi-branch support allows you to manage inventory, employees, and sales across all your locations from a single dashboard. Each location maintains its own data while contributing to centralized reporting.",
    },
    {
      question: "What kind of customer support do you offer?",
      answer:
        "We provide 24/7 customer support through multiple channels including live chat, email, and phone. All plans include access to our comprehensive knowledge base, video tutorials, and dedicated account managers for enterprise clients.",
    },
    {
      question: "Is my sales and customer data secure?",
      answer:
        "Security is our top priority. SalesMaster uses bank-level encryption, regular security audits, and complies with PCI DSS standards. Your data is backed up in multiple secure locations and we never share your information with third parties.",
    },
    {
      question: "Can I integrate with other tools I'm already using?",
      answer:
        "Yes, SalesMaster offers extensive integration capabilities. Connect with popular accounting software like QuickBooks and Xero, e-commerce platforms like Shopify, payment processors, and marketing tools through our REST API.",
    },
    {
      question: "What's included in the free trial?",
      answer:
        "Our 14-day free trial gives you full access to all SalesMaster features. You can process unlimited sales, manage inventory, generate reports, and test all integrations. No credit card required to get started.",
    },
    {
      question: "How does the pricing work for growing businesses?",
      answer:
        "We offer scalable pricing plans that grow with your business. Start with our Basic plan for single stores, upgrade to Professional for multiple locations, or choose Enterprise for advanced features and custom solutions. Volume discounts available.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl">
            Get answers to common questions about SalesMaster setup, features
            and pricing.
          </p>
        </motion.div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      <p className="font-semibold text-gray-900 text-sm group-hover:text-blue-600 transition-colors duration-200">
                        Call Support
                      </p>
                      <p className="text-gray-600 text-xs">+233542095569</p>
                    </div>
                  ...
                  <a
                    href="mailto:sales@namibra.io?subject=SalesMaster Support&body=Hello, I need help with..."
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      <p className="font-semibold text-gray-900 text-sm group-hover:text-green-600 transition-colors duration-200">
                        Email Support
                      </p>
                  ...
                  <a
                    href="https://wa.me/+233257887464?text=Hello%20SalesMaster%20Support,%20I%20need%20help%20with..."
                    target="_blank"
